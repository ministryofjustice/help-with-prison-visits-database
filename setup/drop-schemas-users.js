const dropSchemaUsers = (knex) => {
  return knex.schema
    ...
    // TABLES EXTSCHEMA
    .raw('DROP TABLE IF EXISTS ExtSchema.EligibleChild;')
    .raw('DROP TABLE IF EXISTS ExtSchema.Benefit;')
    ...
    // TABLES INTSCHEMA
    .raw('DROP TABLE IF EXISTS IntSchema.TopUp;')
    .raw('DROP TABLE IF EXISTS IntSchema.EligibleChild;')
    .raw('DROP TABLE IF EXISTS IntSchema.ClaimRejectionReason;')
    .raw('DROP TABLE IF EXISTS IntSchema.Benefit;')
    .raw('DROP TABLE IF EXISTS IntSchema.AutoApproval;')
